...
class OnboardingService:
    ...
    def generate_ci_cd_pipeline(self, app_data):
        """Generate the Jenkins CI/CD pipeline based on application type"""
        try:
    ...
    def _generate_nodejs_pipeline(self, app_data):
        """Generate Node.js specific Jenkins CI/CD pipeline"""
        return f"""// Jenkins CI/CD Pipeline for {app_data['app_name']}
